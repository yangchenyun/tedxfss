...
<div id="content" class="container_16"><?php include 'content/memberlist.php'; ?>
<!-- Generate --> <?php foreach ($members as $member): ?>
<div class="grid_12 prefix_2 suffix_2 item"
	id="<?php echo $member['id']; ?>"><img
	src="<?php echo $member['img']; ?>"
	alt="<?php echo $member['name']; ?>" width="220px"
	class="grid_4 <?php if ($member['id']%2 == 0) { echo 'alt'; } ?>" />
